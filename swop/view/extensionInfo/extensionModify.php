...
$choice_root_display = session("isRoot") ? " style='display:none' " : "";
?>
    ...
    <table class="table table-v">
        <tbody>
            ...
            <tr>
                <td>錄音:</td>
                <td>
                    <input id='startRecorder' name='startRecorder' class='bootstrap-switch' type='checkbox' value="1" <?php echo ($data["StartRecorder"] ? "checked" : "") ?> data-size='mini' data-off-color='danger'>
                </td>
            </tr>
            <tr>
                <td>狀態:</td>
                <td>
                    ...
                    ?>
                    <input id='suspend' name='suspend' class='bootstrap-switch' type='checkbox' value="0" <?php echo ($data["Suspend"] == 0 ? "checked" : "") ?> data-size='mini' data-off-color='danger'>
                </td>
            </tr>
            ...
            <tr <?php echo $choice_root_display ?>>
                <td>是否啟用:</td>
                <td>
                    <input id='useState' name='useState' class='bootstrap-switch' type='checkbox' value="1" <?php echo ($data["UseState"] ? "checked" : "") ?> data-size='mini' data-off-color='danger'>
                </td>
            </tr>
